  ...
  return (
    <div className="flex flex-col h-screen  w-full bg-slate-800 mx-auto text-gray-200">
      <div className="flex flex-col justify-center items-center mx-auto my-auto">
        <label className="text-gray-200 mb-2 italic font-semibold">Select a wordlist file to crack the secret</label>
        <input
        ...
        {response && <p className="text-white font-bold">Secret key: <span className="font-normal italic text-xl">{response}</span></p>}
